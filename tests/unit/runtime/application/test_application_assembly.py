...
def test_assembly_can_register_agent_runtime():
    ...
    assert assembly.components.get("agent_runtime") is agent_runtime
...
def test_assembly_can_register_multiple_components():
    ...
    agent_runtime, execution_runtime = create_runtime_services()
...
def test_assembly_preserves_agent_instance_identity():
    assembly = create_assembly()
